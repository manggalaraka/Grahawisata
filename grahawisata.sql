...
CREATE TABLE `pengguna` (
  ...
  `privilege` enum('admin','owner','manajer','receptionist') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `pengguna` (`id`, `username`, `name`, `email`, `privilege`, `password`, `alamat`, `telepon`, `foto`, `pertanyaan_pemulih`, `jawaban_pemulih`, `remember_token`, `created_at`, `updated_at`, `activated`, `is_delete`) VALUES
(1, 'admin', 'admin', 'mangga.raka@yahoo.co.id', 'admin', '$2y$10$NHY4i1iz/6zyURSD.TJ.wOF//qeDtHE7yx5Tm78wG7s4NUvOTSzaO', '', '', '', '', '', 'MFM0O9EkjUqfZm1tY2wutOTEyULKaVLqMpkwA5Pv10hnipPAXQt1dHz63Jfl', NULL, NULL, 'yes', 'no');
